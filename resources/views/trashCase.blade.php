                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">
                      ...
                      @foreach (getProjects() as $record)
                        <a class="dropdown-item" href=" <a class="dropdown-item" href="{{ route('selectProject', $record->id) }}">{{$record->Project_Title}}</a>
                        @endforeach
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="pull-right">
                      <a href="{{route('case.reportcase')}}" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Case Report</a></a>
                  </div>
             ...
             @csrf
              ...
              <div class="card-body">
                <table id="trashCase" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>Modul Name</th>
                    <th>Case Name</th>
