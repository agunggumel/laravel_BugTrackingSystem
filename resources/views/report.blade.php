        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Module Report</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="pull-right">
                      <a href="{{route('module')}}" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Add New Module</a></a>
                      <a href="{{route('trashModule')}}" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Recycle Bin</a></a>
                  </div>
        @endif
...
<script>
   $().ready(function(){
    $("#report").DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{route('report.getReport')}}",
        "columns": [
            {data: 'Project_id', orderable: false},
            {data: 'Module_Name', orderable: false},
