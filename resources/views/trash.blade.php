...
{{--    </form>--}}
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="pull-right">
                      <a href="{{route('report')}}" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i>Modul Report</a> </a>
                  </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-2020 <a href="#">Cican</a>.</strong> All rights
    reserved.
  </footer>
